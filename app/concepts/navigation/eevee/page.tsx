...
export default async function EeveePage() {
	...
	const response = await PokemonAPI.get<Pokemon>("/pokemon/eevee");
				...
				<CardContent className="p-4">
					<div className="flex items-start gap-3">
						...
						<div className="flex-1">
							<p className="mb-1 font-semibold text-sm">Fast Response</p>
							<p className="text-muted-foreground text-xs leading-relaxed">
								This page loaded quickly (~0.6s). Try switching between tabs to
								feel the instant navigation. Loaded at{" "}
